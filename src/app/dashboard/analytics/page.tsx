...
const Analytics = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8">
      <div className=" relative max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <Link
          href="/dashboard"
          className="absolute right-[32px] bottom-[10px]  px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
        >
          Back
        </Link>
      </div>
